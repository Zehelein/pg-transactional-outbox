...
TRX_NEXT_MESSAGES_FUNCTION_NAME=next_inbox_messages
`;
...
TRX_INBOX_NEXT_MESSAGES_POLLING_INTERVAL_IN_MS=500
TRX_NEXT_MESSAGES_POLLING_INTERVAL_IN_MS=500
TRX_INBOX_NEXT_MESSAGES_FUNCTION_NAME=next_outbox_messages
TRX_NEXT_MESSAGES_FUNCTION_NAME=next_outbox_messages
`;
